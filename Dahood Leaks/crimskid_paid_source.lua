    ...
    loadstring(game:HttpGet("https://pastebin.com/raw/hNdtMny7"))()
    ...
    Text.Text = "Crimskid | Da Hood Modded"
    ...
    local function NKXPFO_fake_script() -- Text.LocalScript 
        local script = Instance.new('LocalScript', Text)
            ...
            script.Parent.Text = ("Crimskid | " ..game.Players.LocalPlayer.Name.. " | " ..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.. "")
    end
    ...
    local Movement = two:AddSection("Movement"); 
    local TargetAim = one:AddSection("Target Aim"); 
    local TargetAimCustom = one:AddSection("Target Aim Customization"); 
    local AntiAim = one:AddSection("Anti Aim"); 
    local Bot = two:AddSection("Bot"); 
    ...
    TargetAim:AddToggle({text = "Target Aim", callback = function(a)
    
       getgenv().Target = a
    
    end}) 
    
    TargetAim:AddToggle({text = "Chat Mode", callback = function(state)
        getgenv().ChatMode = state
    end}) 
    
    TargetAim:AddToggle({text = "Notification Mode", callback = function(state)
        getgenv().NotifMode = state
    end}) 
    
    TargetAim:AddToggle({text = "Ping Based Prediction", callback = function(state)
        getgenv().AutoPrediction = state
    end}) 
    
    TargetAim:AddBox({text = "Prediction", value = 0.151, callback = function(awdawdawd)
        getgenv().Prediction = awdawdawd
    end}) 
    
    TargetAim:AddButton({text = "Set Normal Prediction", callback = function()
        getgenv().Prediction = 0.151
    end}) 
    
    TargetAim:AddList({text = "BodyPart", max = 4, flag = "", values = {"Head", "HumanoidRootPart"}, value = "HumanoidRootPart", callback = function(v)
        getgenv().Partz = v
    end})
    
    
    
    TargetAimCustom:AddColor({text = "Color", callback = function(color)
        _G.targetaimcolor = color
    end})
    
    TargetAimCustom:AddSlider({text = "Size", min = 1, max = 100, value = 14, callback = function(size)
        _G.targetaimsize = Vector3.new(size,size,size)
    end})
    
    TargetAimCustom:AddSlider({text = "Transparency", min = 1, max = 10, value = 8, callback = function(size)
        _G.targetaimtransparency = size * 0.1
    end})
    ...
    Movement:AddBind({text = "Speed", key = "Y", callback = function(state)
        toggle = state 
    ...
    Movement:AddSlider({text = "CFrame Speed", min = 0, max = 18, value = 5, callback = function(speed)
    getfenv().Speed = speed * 0.40
    end});
    
    getgenv().urspeed = 500
    
    Movement:AddBind({text = "Spin-Bot", key = "Y", callback = function(state)
        spintoggle = state 
    ...
    Movement:AddSlider({text = "Spin Speed", min = 1, max = 100, value = 100, callback = function(speed)
            getgenv().urspeed = speed *5
    end})
            
    Movement:AddToggle({text = "No Jump-Cooldown", callback = function(state)
        _G.nocooldown = state
    end}) 
    
    Movement:AddButton({text = "Fly (X)", callback = function()
    ...
    Movement:AddSlider({text = "Fly Speed", min = 1, max = 30, value = 5, callback = function(speed)
        _G.flyspeedbaka = speed
    end})
    
    Movement:AddButton({text = "Bypass", callback = function()
        loadstring(game:HttpGet("https://pastebin.com/raw/vDWJq6Wa"))()
    end})
    
    Movement:AddSlider({text = "HipHeight", min = 2 , max = 120, value = 2, callback = function(speed)
         
        _G.hipheight = speed
        game.Players.LocalPlayer.Character.Humanoid.HipHeight = _G.hipheight
    end}) 
    
    Movement:AddBind({text = "HipHeight Bind", key = "", callback = function(state)
    if state == true then
    ...
    Movement:AddBind({text = "Jitter-Bot", key = "", callback = function(state)
        local Angle = 180
    ...
    Movement:AddSlider({text = "Jitter-Bot Speed", min = 1, max = 100, value = 100, callback = function(speed)
        _G.delayswitch = speed *0.0010
    end})
    
    Movement:AddBind({text = "Noclip", key = "", callback = function(state)
    ...
    Movement:AddToggle({text = "Infinite Jump", callback = function(state)
    ...
    Movement:AddSlider({text = "Infinite Jump Velocity", min = 1, max = 500, value = 50, callback = function(speed)
        _G.JumpHeight = speed
    end})
    ...
    Bot:AddToggle({text = "Bot", callback = function(state)
    ...
    Bot:AddBind({text = "Bind", key = "", callback = function(state)
        _G.bot = state
        local Radius = 35
        local lplr = game:GetService("Players").LocalPlayer
    ...
    Bot:AddButton({text = "Reach", callback = function()
    ...
    Bot:AddToggle({text = "Underground", callback = function(state)
    ...
    Bot:AddSlider({text = "Up", min = -50, max = 50, value = 0, callback = function(speed)
        _G.up = speed
    end})
    
    Bot:AddSlider({text = "Sideways", min = -50, max = 50, value = 0, callback = function(speed)
        _G.sideways = speed
    end})
    
    Bot:AddSlider({text = "Backwards", min = -50, max = 50, value = 5, callback = function(speed)
        _G.distance = speed
    end})
    
    -- [Bot Section End ] -----------------------------------------------------------------------------------------------------------------------------------------------------
    
    -- [Anti Aim Section Start ] -----------------------------------------------------------------------------------------------------------------------------------------------------
    
    AntiAim:AddToggle({text = "Camera", callback = function(state)
       getgenv().CameraToggle = state
    --// Variables
    local plrs = game:GetService("Players")
       ...
       --//Making Camera
       local Camera = Instance.new("Part", ws)
           Camera.CanCollide = false
           Camera.Color = Color3.fromRGB(0, 0, 0)
           Camera.Size = Vector3.new(0.1, 0.1, 0.1)
           ...
           --//Setting the Camera
           ws.CurrentCamera.CameraSubject = Camera
           ...
           rs.RenderStepped:Connect(function()
               ...
               local chr = plr.Character
                       ...
                       --//Check If On
                       if getgenv().CameraToggle == true then
                       --//Incase Player Dies
               ws.CurrentCamera.CameraSubject = Camera
    
                       --//Tweening The Camera
                       ts:Create(Camera, TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {CFrame = (OldPos or CFrame.new(hrp.CFrame.p))}):Play()
                       else
    ...
    AntiAim:AddBind({text = "Bind", nomouse = true, key = "", callback = function(state)
       getgenv().CameraToggle = state
    --// Variables
    local plrs = game:GetService("Players")
       local ts = game:GetService("TweenService")
    ...
    AntiAim:AddToggle({text = "Circle", callback = function(state)
        CRIMSKIDAA = state 
        if CRIMSKIDAA == true then
            repeat
           
    game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame.lookVector * getgenv().spinaapower
    ...
    AntiAim:AddSlider({text = "Vector", min = -100, max = 100, value = 5, callback = function(speed)
     getgenv().spinaapower = speed * 5
    end}) 
    
    AntiAim:AddToggle({text = "Ball Spin", callback = function(state)
    _G.ballspin = state 
    local spinnyball = _G.spinballpower
    
    while _G.ballspin == true  do 
        task.wait()
        
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,0,0) * CFrame.Angles(math.random(1,spinnyball), math.random(1,spinnyball), math.random(1,spinnyball))
    task.wait() 
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(0,0,0) * CFrame.Angles(math.random(1,spinnyball), math.random(1,spinnyball), math.random(1,spinnyball))
    ...
    AntiAim:AddSlider({text = "Power", min = 1, max = 100, value = 1, callback = function(speed)
    _G.spinballpower = speed * 5
    end}) 
    
    _G.rangeonee = 0
    _G.rangetwoo = 10
    
    AntiAim:AddToggle({text = "Slingshot", callback = function(state)
    loadstring(game:HttpGet("https://pastebin.com/raw/cQeNPrr5"))()
    
    
    _G.slingshotaa = state 
    local rangeone = _G.rangeonee
    local rangetwo = _G.rangetwoo
    
    
    while _G.slingshotaa == true do 
        task.wait()
    game.Players.LocalPlayer.Character.Humanoid.HipHeight = math.random(rangeone,rangetwo)
    ...
    AntiAim:AddSlider({text = "Range 1", min = -100, max = 100, value = 0, callback = function(speed)
    _G.rangeonee = speed
    end}) 
    
    AntiAim:AddSlider({text = "Range 2", min = -100, max = 100, value = 20, callback = function(speed)
    _G.rangetwoo = speed 
    end}) 
    ...
    AntiAim:AddToggle({text = "Side Step OPM", callback = function(state)
    _G.sidestep = state 
    
    local sidestepincrease = _G.sidestepinc 
    local sidestepten = _G.sidestepten 
    while _G.sidestep == true  do 
        task.wait()
        
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(sidestepincrease,0,0) 
    task.wait() 
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(-sidestepincrease,0,0) 
    task.wait() 
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(sidestepten,0,0) 
    task.wait() 
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(-sidestepten,0,0) 
    task.wait() 
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame*CFrame.new(-sidestepincrease,0,0) 
    ...
    AntiAim:AddSlider({text = "Range 1", min = -50, max = 50, value = 5, callback = function(speed)
    _G.sidestepinc  = speed 
    end}) 
    
    AntiAim:AddSlider({text = "Range 2", min = -50, max = 50, value = 10, callback = function(speed)
    _G.sidestepten  = speed 
    end}) 
    _G.angleforaa = 100 
    _G.strength = 120 
    
    AntiAim:AddToggle({text = "Spin", callback = function(state)
                         _G.spinny = state 
                          local angle = _G.angleforaa
                         while _G.spinny == true do 
                             task.wait()
                          local char = game.Players.LocalPlayer.Character
    
                 
                   game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.Angles(0, math.rad(angle), 0)           
                           char.HumanoidRootPart.Velocity = char.HumanoidRootPart.CFrame.lookVector * _G.strength
    end 
    end}) 
    ...
    AntiAim:AddSlider({text = "Power", min = -50, max = 50, value = 12, callback = function(speed)
    _G.strength = speed * 10 
    end}) 
        
    
    
    AntiAim:AddSlider({text = "Angle", min = -50, max = 50, value = 10, callback = function(speed)
    _G.angleforaa = speed * 10
    end})
    
    
    _G.BlatantAApowerg = 10 
    
    AntiAim:AddToggle({text = "Mass Teleport", callback = function(state)
        local Position = game.Players.LocalPlayer.Character.HumanoidRootPart.Position
        getgenv().BlatantAA = state 
        local BlatantAApower = _G.BlatantAApowerg
    while getgenv().BlatantAA == true  do
        task.wait()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = (CFrame.new(Position) + Vector3.new(math.random(-BlatantAApower, BlatantAApower), math.random(-BlatantAApower, BlatantAApower), math.random(-BlatantAApower, BlatantAApower))) * CFrame.Angles(math.rad(math.random(-180, 180)), math.rad(math.random(-180, 180)), math.rad(math.random(-180, 180)))
    end
    end}) 
    ...
    AntiAim:AddSlider({text = "Power", min = 0, max = 50, value = 10, callback = function(speed)
    _G.BlatantAApowerg  = speed
    end}) 
    -- [Anti Aim Section End ] -----------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    local Visuals = three:AddSection("Visuals"); 
    local Misc = three:AddSection("Misc"); 
    local Teleports = four:AddSection("Teleports"); 
    local Autofarms = four:AddSection("Autofarms"); 
    local esp = four:AddSection("ESP"); 
    local GripPos = four:AddSection("Grip-Pos"); 
    ...
    Visuals:AddToggle({text = "FF Body", callback = function(state)
        _G.ffbody = state 
        while _G.ffbody == true do 
            task.wait()
    ...
    Visuals:AddColor({text = "FF Body Color", callback = function(colorpick)
        
        if _G.ffbody == true then 
    ...
    Visuals:AddToggle({text = "FF Gun", callback = function(state)
        while state == true do 
            task.wait()
                for i,v in pairs(game:GetService'Players'.LocalPlayer.Character:GetChildren())do
            if v:isA("Tool") then
    ...
    Visuals:AddColor({text = "FF Gun Color", callback = function(colorpick)
        _G.colourforthing = colorpick
        while wait() do 
            task.wait()
        for i,v in pairs(game:GetService'Players'.LocalPlayer.Character:GetChildren())do
            if v:isA("Tool") then
               v.Handle.Color = _G.colourforthing
            end 
    end 
        end 
    end}) 
    
    Visuals:AddToggle({text = "FF Radio On Back", callback = function(state)
        while state == true do 
            task.wait()
    ...
    Visuals:AddColor({text = "FF Radio Colour", callback = function(colorpick)
            game.Players.LocalPlayer.Character.Radio.Color = colorpick
    end}) 
    
    Visuals:AddToggle({text = "Chroma Body", callback = function(state)
        _G.chromaff = state
    ...
    Visuals:AddButton({text = "Remove Radio", callback = function()
        game.Players.LocalPlayer.Character.Radio:Destroy()
    end}) 
    
    Visuals:AddButton({text = "Remove Mask", callback = function()
        game.Players.LocalPlayer.Character.Mask:Destroy()
    
    end})
    
    Visuals:AddColor({text = "Ambient", color = Color3.new(0.470081627368927,0.4685755670070648,0.47093021869659426) , callback = function(colorpick)
        game:GetService("Lighting").OutdoorAmbient = colorpick
    end})
    
    
    Visuals:AddColor({text = "Fog Color", color = Color3.fromRGB(100, 87, 72) , callback = function(colorpick)
        game:GetService("Lighting").FogColor = colorpick
    end})
    
    Visuals:AddColor({text = "Tint", color = Color3.new(1,1,1) , callback = function(colorpick)
        game:GetService("Lighting").ColorCorrection.TintColor = colorpick
    end})
    
    Visuals:AddButton({text = "No animation", callback = function()
    ...
    Visuals:AddButton({text = "Remove Hats", callback = function()
    ...
    Misc:AddToggle({text = "Anti Stomp", callback = function(state)
        _G.antistomptoggle = state 
        
        
    game:GetService("RunService").RenderStepped:Connect(function()
        if  _G.antistomptoggle == true then 
            if game.Players.LocalPlayer.Character.Humanoid.Health <= 10 and _G.antistomptoggle == true then
                game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity = Vector3.new(400,400,400)
    ...
    Misc:AddToggle({text = "Auto Stomp", callback = function(state)
        _G.autostomp =  state
    ...
    Misc:AddToggle({text = "Anti-Grab", callback = function(state)
        _G.antigrab = state
    ...
    Misc:AddToggle({text = "Kill Anyone Carrying You", callback = function(state)
        _G.killcarry = state
    ...
    Misc:AddToggle({text = "Disable all seats", callback = function(state)
        if state == true then
    ...
    Misc:AddToggle({text = "Show Chat", callback = function(state)
       if state == true then
    ...
    Misc:AddToggle({text = "Infinite Zoom", callback = function(state)
        if state == true then
    ...
    Teleports:AddButton({text = "Revolver", callback = function()
        ...
        tp(-618.246094, 327.748352, 85.671936, 1, 0, 0, 0, 1, 0, 0, 0, 1);
    end})
    
    Teleports:AddButton({text = "DB", callback = function() 
        local plr = game:service"Players".LocalPlayer;
        local tween_s = game:service"TweenService";
        local info = TweenInfo.new(10,Enum.EasingStyle.Quad);
        function tp(...)
        ...
        tp(-1013.24921, 327.755249, -51.5214233, 1, 0, 0, 0, 1, 0, 0, 0, 1);
    end})
    
    Teleports:AddButton({text = "Mid Shield", callback = function() 
        local plr = game:service"Players".LocalPlayer;
        local tween_s = game:service"TweenService";
        local info = TweenInfo.new(10,Enum.EasingStyle.Quad);
        function tp(...)
        ...
        tp(-909.083984, 280.733887, 782.327026, 1, 0, 0, 0, 1, 0, 0, 0, 1);
    end})
    
    Teleports:AddButton({text = "Golden AK", callback = function()  
    ...
    Teleports:AddButton({text = "Casino", callback = function() 
        local plr = game:service"Players".LocalPlayer;
        local tween_s = game:service"TweenService";
        local info = TweenInfo.new(7,Enum.EasingStyle.Quad);
        function tp(...)
    ...
    Teleports:AddButton({text = "Lettuce", callback = function() 
        local plr = game:service"Players".LocalPlayer;
        local tween_s = game:service"TweenService";
        local info = TweenInfo.new(7,Enum.EasingStyle.Quad);
        function tp(...)
    ...
    Teleports:AddButton({text = "Safe Place", callback = function() 
        local plr = game:service"Players".LocalPlayer;
        local tween_s = game:service"TweenService";
        local info = TweenInfo.new(10,Enum.EasingStyle.Quad);
        function tp(...)
    ...
    Autofarms:AddToggle({text = "Lettuce Farm", callback = function(state)
    ...
    Autofarms:AddToggle({text = "Weight Farm", callback = function(state)
        _G.weightfarm = state 
    ...
    GripPos:AddToggle({text = "Grip-Pos", callback = function(state)
    ...
    GripPos:AddSlider({text = "Forwards", min = -50, max = 50, value = 5, callback = function(speed)
        
        _G.gripposforwards = speed
    
    end}) 
    
    GripPos:AddSlider({text = "Upwards", min = -50, max = 50, value = 5, callback = function(speed)
        
        _G.gripposupwards = speed
    
    end})
    
    GripPos:AddSlider({text = "Sideways", min = -50, max = 50, value = 5, callback = function(speed)
        
        _G.grippossideways = speed
    
    end})
    
    GripPos:AddButton({text = "Invis Weapon", callback = function()
        local player = Game.Players.LocalPlayer
        if player.Character:FindFirstChildWhichIsA('Tool') then
            player.Character:FindFirstChildWhichIsA('Tool').Grip = CFrame.new(-4, 10 , 0)
    ...
    sixsection:AddList({text = "Idle", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
    ...
    sixsection:AddList({text = "Run", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
        "Elder","Ghost","Knight","Levitation","Mage","Astronaut","Ninja","OldSchool","Patrol","Pirate","Popstar","Princess","Robot",
        "Rthro","Stylish","Superhero","Toy","Vampire","Werewolf",}, 
        value = "", callback = function(State)
            local LocalPlayer = game.Players.LocalPlayer
    ...
    sixsection:AddList({text = "Walk", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
        "Elder","Ghost","Knight","Levitation","Mage","Astronaut","Ninja","OldSchool","Patrol","Pirate","Popstar","Princess","Robot",
        "Rthro","Stylish","Superhero","Toy","Vampire","Werewolf",}, 
    ...
    sixsection:AddList({text = "Climb", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
        "Elder","Ghost","Knight","Levitation","Mage","Astronaut","Ninja","OldSchool","Patrol","Pirate","Popstar","Princess","Robot",
        "Rthro","Stylish","Superhero","Toy","Vampire","Werewolf",}, 
        value = "", callback = function(State)
                    local LocalPlayer = game.Players.LocalPlayer
    ...
    sixsection:AddList({text = "Fall", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
        "Elder","Ghost","Knight","Levitation","Mage","Astronaut","Ninja","OldSchool","Patrol","Pirate","Popstar","Princess","Robot",
        "Rthro","Stylish","Superhero","Toy","Vampire","Werewolf",}, 
        value = "", callback = function(State)
                    local LocalPlayer = game.Players.LocalPlayer
    ...
    sixsection:AddList({text = "Jump", max = 10, flag = "", values = {"Nothing", "Astronaut","Bubbly","Cartoony","Confindent","Cowboy","Zombie",
        "Elder","Ghost","Knight","Levitation","Mage","Astronaut","Ninja","OldSchool","Patrol","Pirate","Popstar","Princess","Robot",
        "Rthro","Stylish","Superhero","Toy","Vampire","Werewolf",}, 
        value = "", callback = function(State)
                    local LocalPlayer = game.Players.LocalPlayer
    ...
    library:selectTab(library.tabs[1]);
            ...
            loadstring(game:HttpGet("https://pastebin.com/raw/kcqgWZnm"))()
