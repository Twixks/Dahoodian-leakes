...
loadscreen3:AddButton(
    ...
    function()
        ...
        if versionthing == "Private" then --Memelouse#3150
            ...
            local Window = Library:CreateWindow("Sanky Box", Vector2.new(500, 700), Enum.KeyCode.RightControl)
                ...
                game:GetService("RunService").Heartbeat:Connect(
                    function()
                        if getgenv().Velocityres2 then
                            ...
                            if
                                AimlockTarget and resolvertypev22 == "DetectDesync" and AimlockTarget.Character ~= nil and
                                    AimlockTarget.Character:FindFirstChild("HumanoidRootPart")
                             then
                                if
                ...
                game:GetService("RunService").Heartbeat:Connect(
                    function()
                        if Chingbing33 then
                            ...
                            if
                                game.Players[targetplr] and resolvertypev2 == "DetectDesync" and
                                    game.Players[targetplr].Character ~= nil and
                                    game.Players[targetplr].Character:FindFirstChild("HumanoidRootPart")
                             then
                                if
                                    game.Players[targetplr].Character:WaitForChild("HumanoidRootPart").Velocity.magnitude >
                                        Resolverdetections
                                 then
                                    pcall(
                                        function()
                                            local hr9p = game.Players[targetplr].Character.HumanoidRootPart
                                            hr9p.Velocity = Vector3.new(0, 0, 0)
                                            hr9p.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
                                        end
                                    )
                                end
                            end
            ...
            if antilockenabled then
                ...
                game:GetService("RunService").Heartbeat:Connect(
                    function()
                        if velocitywalk == true then
                            ...
                            elseif velocitytype == "MouseControl" then
                                LocalPlayer.Character.HumanoidRootPart.Velocity =
                                    ...
                                    Powervel +
                                    workspace.CurrentCamera.CFrame.LookVector * Powervel
                                if visualizevelocity == true then
                                    velocityball.Transparency = 0
                                    velocityball.Position =
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position +
                                        (game.Players.LocalPlayer:GetMouse().hit.p -
                                            game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Unit *
                                            Powervel +
                                        workspace.CurrentCamera.CFrame.LookVector * Powervel
                                else
                                    velocityball.Transparency = 1
                            ...
                            elseif velocitytype == "Up" then
                                ...
                                if visualizevelocity == true then
                                    ...
                                    velocityball.Position =
                                        Vector3.new(
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position.X,
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Y + 10 * (Powervel),
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position.Z
                                    )
                                else
                                    velocityball.Transparency = 1
                            ...
                            elseif velocitytype == "MultiPlier" then
                                ...
                                if visualizevelocity == true then
                                    ...
                                    velocityball.Position =
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.Position +
                                        (game.Players.LocalPlayer.Character.LowerTorso.Velocity * Velmultiplier / 10)
                                else
                                    velocityball.Transparency = 1
                                end
                            end
                ...
                local visualizedesyncvelspoofer =
                    antilock63:AddToggle(
                    "Visualize",
                    false,
                    function(Boolean)
                        visualizevelocity = Boolean
                    end
                )

                visualizedesyncvelspoofer:AddColorpicker(
                    Color3.fromRGB(0, 140, 175),
                    function(Color)
                        velocityball.Color = Color
                    end
                )
                ...
                local velocitytypetype =
                    antilock63:AddDropdown(
                    "Type",
                    {"Custom", "MultiPlier", "MouseControl", "NoVelocity", "Random", "Underground", "Up", "LookVector"},
                    "Custom",
                    false,
                    function(Value)
                        velocitytype = Value
